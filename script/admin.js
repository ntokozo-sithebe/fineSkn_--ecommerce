      ...
      products.forEach((product) =>{
        fineWrapper.innerHTML +=
                         `<div class="row"> <tr>
                            ...
                            <td> ${product.Price}</td>
                            <td><button type="button" class="rounded-3 bg-info-emphasis p-3 m-1" data-bs-toggle="modal" data-bs-target="#exampleModal"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
                            ...
                            <button class="rounded-3 bg-info p-3 m-1"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
