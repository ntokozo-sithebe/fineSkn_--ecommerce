...
// function to display products on a new page 
 
function ViewAdmin(product){  
  ...
  <tbody>
    <tr>
      <th scope="row"><img src="${product.image}" alt="prod1"></th>
  ...
  <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@fat">New Product Modal</button>
